...
def main():
    ...
    # # 动态计算 full time series length (floor(T'/step_length)*step_length)
    # # Use dataset attributes rather than hard-coded 65
    # full_steps = ds_std.original_sample_length * ds_std.subsample_step
    # # full_steps = floor(T' / step_length) * step_length
    # used_subsample_len = full_steps
...
#     # Dynamically calculate full time series length (floor(T'/step_length)*step_length)
#     # Use dataset attributes rather than hard-coded 65
#     full_steps = ds.original_sample_length * ds.subsample_step
#     used_subsample_len = full_steps
...
#     # Use the ds_standard attributes to dynamically determine subsample length
#     # rather than hard-coding 65
#     used_subsample_len = (ds_standard.original_sample_length // args.step_length) * args.step_length
