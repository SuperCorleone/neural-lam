...
#             # np_arr = np.load(sample_path)
#             # full_sample = torch.from_numpy(np_arr).float()
#             # print(f"Loading file: {sample_path}")
#             # np_array = np.load(sample_path)
#             # print(f"Shape: {np_array.shape}, dtype: {np_array.dtype}")
#             # full_sample = torch.tensor(np_array, dtype=torch.float32)
...
# # sample_path = "data/data_07/samples/train/nwp_2022070500_mbr012.npy"
# # try:
# #     print(f"Loading file: {sample_path}")
# #     np_array = np.load(sample_path)
# #     print(f"Shape: {np_array.shape}, dtype: {np_array.dtype}")
...
# # np.load("data/data_07/samples/train/nwp_2022070500_mbr012.npy", allow_pickle=True)
